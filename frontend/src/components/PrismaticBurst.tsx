...
export default function PrismaticBurst({
  ...
  useEffect(() => {
    ...
    gl.canvas.style.mixBlendMode = mixBlendMode && mixBlendMode !== 'normal' ? mixBlendMode : ''
    ...
    return () => {
      ...
      if (gradientTextureRef.current?.texture) gl.deleteTexture(gradientTextureRef.current.texture)
  ...
  }, [animationType, colors, distort, intensity, offset.x, offset.y, rayCount, speed])
